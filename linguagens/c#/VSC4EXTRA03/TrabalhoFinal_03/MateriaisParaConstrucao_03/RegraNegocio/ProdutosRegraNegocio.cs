            ...
            try
            {
                ...
                if (dadosTabela.Rows.Count > 0)
                {
                    for (int i = 0; i < dadosTabela.Rows.Count; i++) //Percorre cada linha da tabela em memória.
                    {
                        ...
                        {
                            novoProduto = new AcessoDados.ProdutosAcessoDados();
                            novoProduto.Alterar(idProduto, codigoBarras, nome, descricao, idUnidade, idCategoria, estoqueMinimo, estoqueAtual, valorCompra, valorVenda,
                                                margem, anotacoesProdutos, situacaoProdutos, dataCadastroProduto);
                        }
