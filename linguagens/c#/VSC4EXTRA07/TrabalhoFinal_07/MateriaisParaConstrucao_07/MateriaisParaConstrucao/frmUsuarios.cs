    ...
    public partial class frmUsuarios : Form
    {
        ...
        private void dtgUsuarios_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    criptografar = new RegraNegocio.Criptografia();
                    string senhaDecripto = criptografar.Descriptografar(dtgUsuarios.Rows[e.RowIndex].Cells["SENHA"].Value.ToString());
                    ...
                    txtSenha.Text = senhaDecripto;
                    txtSenha2.Text = senhaDecripto;
